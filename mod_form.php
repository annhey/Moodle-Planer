...
class mod_scheduler_mod_form extends moodleform_mod {
    ...
    function definition() {
        ...
        $mform->addElement('selectyesno', 'allowstudentcomment', get_string('allowstudentcomment', 'scheduler'));
        $mform->addHelpButton('allowstudentcomment', 'allowstudentcomment', 'scheduler');
