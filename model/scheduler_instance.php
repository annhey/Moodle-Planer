...
class scheduler_instance extends mvc_record_model {
    ...
    /**
     * Whether this scheduler uses student messages and files.
     * If so, they are saved as "slot notes" and visible to teacher and student.
     * @return whether student messages are used
     */
    public function allows_student_comment() {
        return ($this->data->allowstudentcomment);
    }
