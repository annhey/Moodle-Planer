 ...
 * @authors    2014 Henning Bostelmann and others (see README.txt)
...
class scheduler_slot_table implements renderable {
    ...
    public function add_slot(scheduler_slot $slotmodel, scheduler_appointment $appointmentmodel,
        ...
        // Add as slotnote any message and/or files sent by the student 
        if ($this->scheduler->allows_student_comment()) {
            $studentcomment = $appointmentmodel->studentcomment;
            if (($studentcomment != null) && ($studentcomment != '')) {
                $slot->slotnote .= $studentcomment;
            }
        }
