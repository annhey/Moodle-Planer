...
$string['autoschedule'] = 'Automatische Terminzuweisung';
...
$string['autoschedule'] = 'Automatic appointment';
...
$string['modalheadlineforstudentcomment'] = 'Book slot';
$string['mode'] = 'Mode';
...
$string['allowstudentcomment'] = 'Offer comment field to students';
...
$string['sendmessageandbook'] = 'Book slot'; // Button label
...
$string['studentcomment'] = 'Book slot'; // Zeitfenster mit Nachrichtenoption buchen
...
$string['timeto'] = 'To:';
$string['titleforbookwithmessage'] = 'Attach a message (optional)';
...
//$string['notes_editor'] = 'Nachricht verfassen.';
//$string['notes_editor_help'] = 'Sie können sofort buchen oder Ihrer Buchung eine Nachricht und/oder Dateien hinzufügen.';
...
$string['allowstudentcomment_help'] = 'If this option is enabled, students can add a message as well as file attachments to their booking.';
...
$string['commentFieldHeadline'] = 'Message to Your Teacher';

$string['sendmessagetoteacher'] = 'Message to Your Teacher';