 ...
 * @authors    2011 Henning Bostelmann and others (see README.txt)
...
function scheduler_action_doaddsession($scheduler, $formdata) {
    ...
    for ($d = 0; $d <= $fordays; $d ++) {
        ...
        (($dayofweek == 0) && ($data->sunday == 1))) {
            ...
            // Check for biweekly ('$data->rrepeats == 2') and monthly ('$data->rrepeats == 4') office hours and skip slots accordingly
            if ( ( ($data->rrepeats == 2) && ($count%2 != 0) ) || ( ($data->rrepeats == 4) && ($count%4 != 0) ) ) {
                $count++;
                continue;
            }
            $count++;
